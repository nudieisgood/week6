    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content border-0">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-sm-6">
              <img class="img-fluid" :src="props.product.imgUrl" alt="" />
            </div>
            <div class="col-sm-6">
              <span class="badge bg-primary rounded-pill">{{ props.product.category }}</span>
              <p>商品描述：{{ props.product.description }}</p>
              <p>商品內容：{{ product.content }}</p>
              <div class="h5" v-if="!product.price"> {{ props.product.origin_price }} 元 </div>
              ...
              <div>
                <div class="input-group">
                  ...
                  <button type="button" class="btn btn-primary" @click="emits('add-to-cart', props.product.id, qty)">
                    加入購物車 </button>
                </div>
              </div>
            </div>
